...
<html>
  <head>
    ...
    <!-- Bootstrap 3.3.5 -->
    <link rel="stylesheet" href="<?= base_url(); ?>t_adminlte/bootstrap/css/bootstrap.min.css">
    <!-- Font Awesome -->
  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="<?= base_url(); ?>t_adminlte/index2.html"><b><?= $page_title;?></a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        <div class="msgBox"><?php $this->view('notification'); ?></div>  
        <p class="login-box-msg">Please Sign in</p>
        <form action="<?= base_url('auth/signin_exe'); ?>" method="post">
    ...
    <!-- jQuery 2.1.4 -->
    <script src="<?= base_url(); ?>t_adminlte/plugins/jQuery/jQuery-2.1.4.min.js"></script>
    <!-- Bootstrap 3.3.5 -->
    <script src="<?= base_url(); ?>t_adminlte/bootstrap/js/bootstrap.min.js"></script>
    <!-- iCheck -->
