...
<div class="login-box">
  <div class="login-logo">
    <a href="<?= base_url(); ?>t_adminlte/index2.html"><b>Login</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Please enter your login and password</p>
...
echo form_open(base_url('adm_ruwaiskita/auth'));
// echo form_open(base_url('adm_ruwaiskita/auth'));
