    ...
    <div class="box">
      ...
      <div class="box-body">
        <div class="form-group row">
            <?= form_label('Quiz type', 'title', ['class'=>'col-sm-2 col-form-label']); ?>
            <div class="col-sm-2">
            <?= form_dropdown('type', $type_options, 'MultiOption', 'id="type" class="form-control"'); ?>
            </div>
        </div>
        <div class="form-group row">
            <?= form_label('Title', 'title', ['class'=>'col-sm-2 col-form-label']); ?>
            <div class="col-sm-5">
            <?= form_input($title); ?>
            </div>
        </div>
