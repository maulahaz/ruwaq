<?php 
	$create_page_url = base_url()."arabic/quiz/tambah";
?>
						...
						<td>
							...
							<div class="btn-group">
							  ...
							  <ul class="dropdown-menu">
							    <li>
							    	<a href="<?= base_url('arabic/quiz/edit/'.$row->id) ?>" data-toggle="tooltip" data-placement="top" title="Edit"> <i class="fa fa-pencil"></i> Edit</a>
							    </li>
							    <li>
							    	<a href="<?= base_url('arabic/quiz/delete/'.$row->id) ?>" data-toggle="tooltip" data-placement="top" title="Delete"> <i class="fa fa-trash"></i> Delete</a>
							    </li>
							    <!-- <li>
							    	<form action="<?//base_url('arabic/quiz/delete/'.$row->id) ?>" method="POST">
