<?php 
  if(isset($dtEdit)){
    $formLocation = base_url().'arabic/quiz/update/'.$dtEdit['id'];
  }else{
  	$formLocation = base_url().'arabic/quiz/store';
  }
    ...
    <div class="box">
      ...
      <div class="box-body">
        ...
        <div class="form-group pull-right">
            ...
            <a href="<?=base_url('arabic/quiz') ?>" class="btn btn-default">Cancel</a>
        </div>
...
<!-- SHOW MODAL -->
<!-- ============================================================== -->
<?= $this->view('quiz/modal_select_questions'); ?>