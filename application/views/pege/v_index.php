<?php 
	$create_page_url = base_url()."arabic/pege/tambah";
?>
    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header with-border">
				...
				<a href="<?= $create_page_url ?>"> <button type="button" class="btn btn-inline btn-primary pull-right" title="Add New Data">+ Soal PG</button></a>
            </div>
            <div class="box-body">
                ...
                <tbody>
			  	<?php  
			  		...
			  		$edt_uid = base_url()."arabic/pege/edit/".$row->id;
			  		$del_uid = base_url()."arabic/pege/hapus/".$row->id;
